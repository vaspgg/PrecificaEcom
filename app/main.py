...
from .fiscal import contexto_fiscal, calcular_imposto, rtc_2026_info
...
def pricing_form(title='',ncm='',category_id='',source='manual',marketplace='ML',listing_type_id='gold_special',price_ref=0,uf_destino='',logistic_type='not_specified',shipping_mode='not_specified',item_id='',origem_mercadoria=0,consumidor_final=True,contribuinte_icms=False):
 ...
 imposto,fiscal_calc_note,fiscal_partes=calcular_imposto(regime,regras,receita,uf_origem,uf_destino,ncm,origem_mercadoria,consumidor_final,contribuinte_icms)
 ...
 fiscal_note=f"Empresa: {html.escape(regime)} | origem {html.escape(uf_origem)} → destino {html.escape(uf_destino)}. {html.escape(fiscal_calc_note)} {html.escape(rtc_2026_info(regime))}"
