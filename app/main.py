...
from .fiscal import contexto_fiscal, calcular_imposto
...
def pricing_form(title='',ncm='',category_id='',source='manual',marketplace='ML',listing_type_id='gold_special',price_ref=0,uf_destino='',logistic_type='not_specified',shipping_mode='not_specified',item_id=''):
 ...
 imposto,fiscal_calc_note=calcular_imposto(regime,regras,receita)
